    ...
    var tx = AggregateBondedTransactionV2(
      ...
      transactions: [
        EmbeddedAccountMetadataTransactionV1(
          ...
          valueSizeDelta: 10,
          value: Uint8List.fromList(hex.decode('313233424143')),
        )
      ],
      signerPublicKey: PublicKey('0x05785D97A5BEB8B77E1F567DA9C2D18048515A01F34E9040EA604C06CF0E6FEC'),
      signature: Signature('0x267C52D9EC00722EFEE5696D994338270A9163F22B3248611FC0E37590BAE07B5FCFB08A075C086962A25D31B42AB283235021C6F8BE3C79EF70AE1B010D9567'),
      fee: Amount('18370164183782063840'),
      deadline: Timestamp(8207562320463688160),
      cosignatures: [],
      transactionsHash: Hash256('0x21CD7DF1DCA82BB7DEF6F46B360EDF56376CCE4C8B80D17F22AD39D5321D052C'));
    expect(hex.encode(tx.serialize()).toUpperCase(), payload);
  });
}
