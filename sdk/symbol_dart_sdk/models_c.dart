...
class TransferTransactionV1 extends StructBase implements IDeserializable {
	...
	TransferTransactionV1 deserialize(dynamic payload) {
		...
		var verifiableEntityHeaderReserved_1 = bytesToInt((buffer.sublist(0, 4)).sublist(0, 4), 4);
		buffer = buffer.sublist(4);
		...
		var entityBodyReserved_1 = bytesToInt((buffer.sublist(0, 4)).sublist(0, 4), 4);
		buffer = buffer.sublist(4);
		if (0 != entityBodyReserved_1) {
			throw RangeError('Invalid value of reserved field ($entityBodyReserved_1)');
		}
		var version = bytesToInt((buffer.sublist(0, 1)).sublist(0, 1), 1);
		...
		var messageSize = bytesToInt((buffer.sublist(0, 2)).sublist(0, 2), 2);
		buffer = buffer.sublist(2);
		var mosaicsCount = bytesToInt((buffer.sublist(0, 1)).sublist(0, 1), 1);
		buffer = buffer.sublist(1);
		var transferTransactionBodyReserved_1 = bytesToInt((buffer.sublist(0, 1)).sublist(0, 1), 1);
		buffer = buffer.sublist(1);
		if (0 != transferTransactionBodyReserved_1) {
			throw RangeError('Invalid value of reserved field ($transferTransactionBodyReserved_1)');
		}
		var transferTransactionBodyReserved_2 = bytesToInt((buffer.sublist(0, 4)).sublist(0, 4), 4);
		buffer = buffer.sublist(4);
