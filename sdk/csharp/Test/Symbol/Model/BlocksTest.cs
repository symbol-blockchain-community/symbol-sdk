...
{
  [Test]
  public void NormalBlockV1_block_1() {
    ...
    Assert.That(Converter.BytesToHex(block.Serialize()), Is.EqualTo(payload));
    Assert.That(Converter.BytesToHex(BlockFactory.Deserialize(payload).Serialize()), Is.EqualTo(payload));
  }
  [Test]
  public void NemesisBlockV1_block_2() {
  ...
  [Test]
  public void ImportanceBlockV1_block_3() {
    ...
    var block = new ImportanceBlockV1(
      network: NetworkType.TESTNET,
