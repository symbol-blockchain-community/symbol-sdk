...
class FactoryClassFormatter(ClassFormatter):
	def generate_deserializer(self):
		...
		method_descriptor.arguments = ['payload: Uint8Array | string']
...
class FactoryFormatter(AbstractTypeFormatter):
	...
	def get_deserialize_descriptor(self):
		body = "if ('string' === typeof payload)\n"
		body +=	'\tpayload = converter.hexToUint8(payload);\n'
...
'''
		methods.append(MethodDescriptor(method_name='static toKey', arguments=['values: number[]'], body=body))
		return methods
