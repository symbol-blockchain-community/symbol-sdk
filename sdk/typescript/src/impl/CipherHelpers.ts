...
const encodeAesGcm = (deriveSharedKey: (privateKey: Uint8Array, recipientPublicKey: Uint8Array) => SharedKey256, privateKey: Uint8Array, recipientPublicKey: Uint8Array, message: Uint8Array, initializationVector: Uint8Array) => {
	const sharedKey = deriveSharedKey(privateKey, recipientPublicKey);
	const cipher = new AesGcmCipher(sharedKey);
