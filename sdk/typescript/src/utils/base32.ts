...
const encodeBlock = (input: { [x: number]: number; }, inputOffset: number, output: any[], outputOffset: number) => {
...
const decodeBlock = (input: { [x: number]: string; }, inputOffset: number, output: Uint8Array, outputOffset: number) => {
