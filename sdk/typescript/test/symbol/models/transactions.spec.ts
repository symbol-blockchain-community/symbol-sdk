import { LinkAction, Address, NamespaceId, AliasAction, 
  ...
  MosaicSupplyChangeTransactionV1, EmbeddedMultisigAccountModificationTransactionV1, MultisigAccountModificationTransactionV1, NamespaceMetadataTransactionV1, EmbeddedNamespaceMetadataTransactionV1,
  NamespaceRegistrationTransactionV1, EmbeddedNamespaceRegistrationTransactionV1, EmbeddedSecretLockTransactionV1, SecretLockTransactionV1, SecretProofTransactionV1,
  EmbeddedSecretProofTransactionV1, EmbeddedMosaicSupplyRevocationTransactionV1, MosaicSupplyRevocationTransactionV1, EmbeddedNodeKeyLinkTransactionV1, NodeKeyLinkTransactionV1,
...
describe('transaction test', () => {
  it('AccountAddressRestrictionTransactionV1_account_address_restriction_single_1', () => {
    ...
    expect(uint8ToHex((TransactionFactory.deserialize(payload)).serialize())).to.be.equal(payload);
    expect(uint8ToHex(tx.serialize()).toUpperCase()).to.be.equal(payload);
  }),
  it('AccountAddressRestrictionTransactionV1_account_address_restriction_single_2', () => {
    ...
    var tx = new AccountAddressRestrictionTransactionV1({
      network: NetworkType.TESTNET,
      restrictionFlags: new AccountRestrictionFlags(AccountRestrictionFlags.ADDRESS.value + AccountRestrictionFlags.OUTGOING.value + AccountRestrictionFlags.BLOCK.value),
      restrictionAdditions: [
        new UnresolvedAddress('TCIFSMQZAX3IDPHUP2RTXP26N6BJRNKEBBKP33I')
      ],
      restrictionDeletions: [],
  ...
  it('AccountAddressRestrictionTransactionV1_account_address_restriction_aggregate_1', () => {
    ...
    var tx = new AggregateBondedTransactionV2({
      ...
      signerPublicKey: new PublicKey('83D1CD2DA160075F016CC04B51397186FEF67006364D851DA9EB0CF3E886E372'),
  ...
  it('AccountAddressRestrictionTransactionV1_account_address_restriction_aggregate_2', () => {
  ...
  it('AccountKeyLinkTransactionV1_account_key_link_single_1', () => {
  ...
  it('AccountKeyLinkTransactionV1_account_key_link_single_2', () => {
  ...
  it('AccountKeyLinkTransactionV1_account_key_link_aggregate_1', () => {
  ...
  it('AccountKeyLinkTransactionV1_account_key_link_aggregate_2', () => {
  ...
  it('AccountMetadataTransactionV1_account_metadata_single_1', () => {
    ...
    var tx = new AccountMetadataTransactionV1({
      ...
      scopedMetadataKey: 10n,
      valueSizeDelta: 10,
      value: hexToUint8('313233424143'),
  ...
  it('AccountMetadataTransactionV1_account_metadata_single_2', () => {
  ...
  it('AccountMetadataTransactionV1_account_metadata_aggregate_1', () => {
  ...
  it('AccountMetadataTransactionV1_account_metadata_aggregate_2', () => {
  ...
  it('AccountMosaicRestrictionTransactionV1_account_mosaic_restriction_single_1', () => {
    ...
    var tx = new AccountMosaicRestrictionTransactionV1({
      ...
      restrictionAdditions: [
        new UnresolvedMosaicId(1000n),
      ],
      restrictionDeletions: [
        new UnresolvedMosaicId(2000n),
      ],
  ...
  it('AccountMosaicRestrictionTransactionV1_account_mosaic_restriction_single_2', () => {
    ...
    var tx = new AccountMosaicRestrictionTransactionV1({
      network: NetworkType.TESTNET,
      restrictionFlags: new AccountRestrictionFlags(AccountRestrictionFlags.MOSAIC_ID.value + AccountRestrictionFlags.BLOCK.value),
      restrictionAdditions: [
        new UnresolvedMosaicId(14624838436596993100n),
      ],
  ...
  it('AccountMosaicRestrictionTransactionV1_account_mosaic_restriction_aggregate_1', () => {
  ...
  it('AccountMosaicRestrictionTransactionV1_account_mosaic_restriction_aggregate_2', () => {
  ...
  it('new AccountOperationRestrictionTransactionV1_account_operation_restriction_single_1', () => {
    ...
    var tx = new AccountOperationRestrictionTransactionV1({
      network: NetworkType.TESTNET,
      restrictionFlags: new AccountRestrictionFlags(AccountRestrictionFlags.OUTGOING.value + AccountRestrictionFlags.TRANSACTION_TYPE.value),
      restrictionAdditions: [
  ...
  it('new AccountOperationRestrictionTransactionV1_account_operation_restriction_single_2', () => {
    ...
    var tx = new AccountOperationRestrictionTransactionV1({
      network: NetworkType.TESTNET,
      restrictionFlags: new AccountRestrictionFlags(AccountRestrictionFlags.OUTGOING.value + AccountRestrictionFlags.TRANSACTION_TYPE.value + AccountRestrictionFlags.BLOCK.value),
      restrictionAdditions: [
  ...
  it('new AccountOperationRestrictionTransactionV1_account_operation_restriction_aggregate_1', () => {
  ...
  it('new AccountOperationRestrictionTransactionV1_account_operation_restriction_aggregate_2', () => {
  ...
  it('AddressAliasTransactionV1_address_alias_single_1', () => {
    ...
    var tx = new AddressAliasTransactionV1({
      network: NetworkType.TESTNET,
      namespaceId: new NamespaceId(9562080086528621131n),
  ...
  it('AddressAliasTransactionV1_address_alias_single_2', () => {
  ...
  it('AddressAliasTransactionV1_address_alias_aggregate_1', () => {
  ...
  it('AddressAliasTransactionV1_address_alias_aggregate_2', () => {
  ...
  it('AggregateBondedTransactionV1_aggregate_bonded_aggregate_1', () => {
        ...
        new EmbeddedTransferTransactionV1({
          ...
          mosaics: [
            new UnresolvedMosaic({
              mosaicId: new UnresolvedMosaicId(95442763262823n),
              amount: new Amount(101n)
            }),
          ],
        }),
        new EmbeddedMosaicSupplyChangeTransactionV1({
          network: NetworkType.TESTNET,
          mosaicId: new UnresolvedMosaicId(6300565133566699913n),
          action: MosaicSupplyChangeAction.INCREASE,
          delta: new Amount(10n),
        })
      ],
  ...
  it('var tx = new AggregateBondedTransactionV2_aggregate_bonded_aggregate_2', () => {
      ...
      transactions: [
        new EmbeddedTransferTransactionV1({
          ...
          mosaics: [
            new UnresolvedMosaic({
              mosaicId: new UnresolvedMosaicId(95442763262823n),
              amount: new Amount(100n)
            }),
          ],
        }),
        new EmbeddedMosaicSupplyChangeTransactionV1({
          network: NetworkType.TESTNET,
          mosaicId: new UnresolvedMosaicId(6300565133566699912n),
          action: MosaicSupplyChangeAction.INCREASE,
          delta: new Amount(10n),
        })
      ],
  ...
  it('AggregateCompleteTransactionV1_aggregate_complete_aggregate_1', () => {
      ...
      transactions: [
        ...
        new EmbeddedTransferTransactionV1({
          ...
          mosaics: [
            ...
            new UnresolvedMosaic({
              mosaicId: new UnresolvedMosaicId(15358872602548358953n),
              amount: new Amount(1n),
            })
          ],
          message: hexToUint8('D600000300504C5445000000FBAF93F7'),
        })
      ],
  ...
  it('AggregateCompleteTransactionV2_aggregate_complete_aggregate_2', () => {
  ...
  it('HashLockTransactionV1_hash_lock_single_1', () => {
    ...
    var tx = new HashLockTransactionV1({
      ...
      mosaic: new UnresolvedMosaic({
        mosaicId: new UnresolvedMosaicId(9636553580561478212n),
        amount: new Amount(10000000n),
    }),
      duration: new BlockDuration(100n),
  ...
  it('HashLockTransactionV1_hash_lock_aggregate_1', () => {
  ...
  it('MosaicAddressRestrictionTransactionV1_mosaic_address_restriction_single_1', () => {
    ...
    var tx = new MosaicAddressRestrictionTransactionV1({
      network: NetworkType.TESTNET,
      mosaicId: new UnresolvedMosaicId(1n),
      restrictionKey: 1311768467294898927n,
      previousRestrictionValue: 9n,
      newRestrictionValue: 8n,
      targetAddress: new UnresolvedAddress('TBA6LOHEA6A465G2X5MSQF66JBYR254GJDPK7MQ'),
  ...
  it('MosaicAddressRestrictionTransactionV1_mosaic_address_restriction_aggregate_1', () => {
  ...
  it('MosaicAliasTransactionV1_mosaic_alias_single_1', () => {
    ...
    var tx = new MosaicAliasTransactionV1({
      network: NetworkType.TESTNET,
      namespaceId: new NamespaceId(13182596108967839652n),
      mosaicId:new MosaicId(10n),
      aliasAction: AliasAction.LINK,
  ...
  it('MosaicAliasTransactionV1_mosaic_alias_single_2', () => {
    ...
    var tx = new MosaicAliasTransactionV1({
      network: NetworkType.TESTNET,
      namespaceId: new NamespaceId(16233676262248077354n),
      mosaicId:new MosaicId(14624838436596993100n),
      aliasAction: AliasAction.UNLINK,
  ...
  it('MosaicAliasTransactionV1_mosaic_alias_aggregate_1', () => {
  ...
  it('MosaicAliasTransactionV1_mosaic_alias_aggregate_2', () => {
  ...
  it('MosaicDefinitionTransactionV1_mosaic_definition_single_1', () => {
    ...
    var tx = new MosaicDefinitionTransactionV1({
      network: NetworkType.TESTNET,
      id:new MosaicId(1528487907914657434n),
      duration: new BlockDuration(10000n),
      nonce: new MosaicNonce(0),
      flags: new MosaicFlags(MosaicFlags.RESTRICTABLE.value + MosaicFlags.SUPPLY_MUTABLE.value),
      divisibility: 4,
  ...
  it('MosaicDefinitionTransactionV1_mosaic_definition_single_2', () => {
    ...
    var tx = new MosaicDefinitionTransactionV1({
      network: NetworkType.TESTNET,
      id:new MosaicId(7263101943551867804n),
      duration: new BlockDuration(1000n),
  ...
  it('MosaicDefinitionTransactionV1_mosaic_definition_single_3', () => {
    ...
    var tx = new MosaicDefinitionTransactionV1({
      network: NetworkType.TESTNET,
      id:new MosaicId(8464520965784812599n),
      duration: new BlockDuration(0n),
      nonce: new MosaicNonce(3095715558),
      flags: new MosaicFlags(MosaicFlags.REVOKABLE.value + MosaicFlags.TRANSFERABLE.value),
      divisibility: 2,
  ...
  it('MosaicDefinitionTransactionV1_mosaic_definition_aggregate_1', () => {
    ...
    var tx = new AggregateBondedTransactionV2({
      ...
      transactions: [
        new EmbeddedMosaicDefinitionTransactionV1({
          network: NetworkType.TESTNET,
          id:new MosaicId(3634317930148777473n),
          duration: new BlockDuration(10000n),
          nonce: new MosaicNonce(0),
          flags: new MosaicFlags(MosaicFlags.RESTRICTABLE.value + MosaicFlags.SUPPLY_MUTABLE.value),
          divisibility: 4,
  ...
  it('MosaicDefinitionTransactionV1_mosaic_definition_aggregate_2', () => {
    ...
    var tx = new AggregateBondedTransactionV2({
      ...
      transactions: [
        new EmbeddedMosaicDefinitionTransactionV1({
          network: NetworkType.TESTNET,
          id:new MosaicId(5991146676974618038n),
          duration: new BlockDuration(1000n),
          nonce: new MosaicNonce(3095715558),
          flags: MosaicFlags.NONE,
          divisibility: 3,
  ...
  it('MosaicDefinitionTransactionV1_mosaic_definition_aggregate_3', () => {
...
it('MosaicGlobalRestrictionTransactionV1_mosaic_global_restriction_single_1', () => {
    ...
    var tx = new MosaicGlobalRestrictionTransactionV1({
      network: NetworkType.TESTNET,
      mosaicId: new UnresolvedMosaicId(1875072453572000775n),
      referenceMosaicId: new UnresolvedMosaicId(7706325451784159270n),
      restrictionKey: 1n,
      previousRestrictionValue: 9n,
      newRestrictionValue: 8n,
  ...
  it('MosaicGlobalRestrictionTransactionV1_mosaic_global_restriction_single_2', () => {
    ...
    var tx = new MosaicGlobalRestrictionTransactionV1({
      network: NetworkType.TESTNET,
      mosaicId: new UnresolvedMosaicId(6207017352306769745n),
      referenceMosaicId: new UnresolvedMosaicId(0n),
      restrictionKey: 4444n,
      previousRestrictionValue: 0n,
      newRestrictionValue: 0n,
  ...
  it('MosaicGlobalRestrictionTransactionV1_mosaic_global_restriction_aggregate_1', () => {
  ...
  it('MosaicGlobalRestrictionTransactionV1_mosaic_global_restriction_aggregate_2', () => {
  ...
  it('MosaicMetadataTransactionV1_mosaic_metadata_single_1', () => {
    ...
    var tx = new MosaicMetadataTransactionV1({
      ...
      targetAddress: new UnresolvedAddress('TBA6LOHEA6A465G2X5MSQF66JBYR254GJDPK7MQ'),
      scopedMetadataKey: 10n,
      targetMosaicId: new UnresolvedMosaicId(1000n),
      valueSizeDelta: 10,
      value: hexToUint8('313233414243'),
  ...
  it('MosaicMetadataTransactionV1_mosaic_metadata_single_2', () => {
  ...
  it('MosaicMetadataTransactionV1_mosaic_metadata_aggregate_1', () => {
  ...
  it('MosaicMetadataTransactionV1_mosaic_metadata_aggregate_2', () => {
  ...
  it('MosaicSupplyChangeTransactionV1_mosaic_supply_change_single_1', () => {
  ...
  it('MosaicSupplyChangeTransactionV1_mosaic_supply_change_single_2', () => {
    ...
    var tx = new MosaicSupplyChangeTransactionV1({
      network: NetworkType.TESTNET,
      mosaicId: new UnresolvedMosaicId(14624838436596993100n),
  ...
  it('MosaicSupplyChangeTransactionV1_mosaic_supply_change_aggregate_1', () => {
  ...
  it('MosaicSupplyChangeTransactionV1_mosaic_supply_change_aggregate_2', () => {
  ...
  it('MultisigAccountModificationTransactionV1_multisig_account_modification_single_1', () => {
  ...
  it('MultisigAccountModificationTransactionV1_multisig_account_modification_aggregate_1', () => {
    ...
    it('NamespaceMetadataTransactionV1_namespace_metadata_single_1', () => {
    ...
    var tx = new NamespaceMetadataTransactionV1({
      ...
      scopedMetadataKey: 10n,
      targetNamespaceId: new NamespaceId(1000n),
      valueSizeDelta: 10,
      value: utf8ToUint8('ABC123'),
  ...
  it('NamespaceMetadataTransactionV1_namespace_metadata_single_2', () => {
  ...
  it('NamespaceMetadataTransactionV1_namespace_metadata_aggregate_1', () => {
  ...
  it('NamespaceMetadataTransactionV1_namespace_metadata_aggregate_2', () => {
  ...
  it('NamespaceRegistrationTransactionV1_namespace_registration_single_1', () => {
  ...
  it('NamespaceRegistrationTransactionV1_namespace_registration_single_2', () => {
    ...
    var tx = new NamespaceRegistrationTransactionV1({
      network: NetworkType.TESTNET,
      duration: new BlockDuration(10000n),
      parentId: new NamespaceId(4635294387305441662n),
      id: new NamespaceId(17411894141110456835n),
      registrationType: NamespaceRegistrationType.CHILD,
      name: utf8ToUint8('subnamespace'),
  ...
  it('NamespaceRegistrationTransactionV1_namespace_registration_aggregate_1', () => {
  ...
  it('NamespaceRegistrationTransactionV1_namespace_registration_aggregate_2', () => {
  ...
  it('NodeKeyLinkTransactionV1_node_key_link_single_1', () => {
  ...
  it('NodeKeyLinkTransactionV1_node_key_link_aggregate_1', () => {
  ...
  it('SecretLockTransactionV1_secret_lock_single_1', () => {
  ...
  it('SecretLockTransactionV1_secret_lock_single_2', () => {
    ...
    var tx = new SecretLockTransactionV1({
      ...
      mosaic: new UnresolvedMosaic({
        mosaicId: new UnresolvedMosaicId(9636553580561478212n),
        amount: new Amount(1311768467294899695n)
    }),
      duration: new BlockDuration(100n),
  ...
  it('SecretLockTransactionV1_secret_lock_aggregate_1', () => {
  ...
  it('SecretLockTransactionV1_secret_lock_aggregate_2', () => {
  ...
  it('SecretProofTransactionV1_secret_proof_single_1', () => {
  ...
  it('SecretProofTransactionV1_secret_proof_aggregate_1', () => {
  ...
  it('TransferTransactionV1_transfer_single_1', () => {
  ...
  it('TransferTransactionV1_transfer_single_2', () => {
    ...
    var tx = new TransferTransactionV1({
      ...
      mosaics: [
        new UnresolvedMosaic({
          mosaicId: new UnresolvedMosaicId(100n),
          amount: new Amount(2n)
    }),
        new UnresolvedMosaic({
          mosaicId: new UnresolvedMosaicId(200n),
          amount: new Amount(1n)
        })
      ],
  ...
  it('TransferTransactionV1_transfer_single_3', () => {
    ...
    var tx = new TransferTransactionV1({
      ...
      mosaics: [
        new UnresolvedMosaic({
          mosaicId: new UnresolvedMosaicId(7490250818323297978n),
          amount: new Amount(3n)
    }),
        new UnresolvedMosaic({
          mosaicId: new UnresolvedMosaicId(8620336746491119575n),
          amount: new Amount(2n)
    }),
        new UnresolvedMosaic({
          mosaicId: new UnresolvedMosaicId(15358872602548358953n),
  ...
  it('TransferTransactionV1_transfer_single_4', () => {
  ...
  it('TransferTransactionV1_transfer_single_5', () => {
    ...
    var tx = new TransferTransactionV1({
      ...
      message: utf8ToUint8("It's some kind of magic, magic"),
  ...
  it('TransferTransactionV1_transfer_single_6', () => {
    ...
    var tx = new TransferTransactionV1({
      ...
      mosaics: [
        new UnresolvedMosaic({
          mosaicId: new UnresolvedMosaicId(12342763262823n),
          amount: new Amount(300n)
    }),
        new UnresolvedMosaic({
          mosaicId: new UnresolvedMosaicId(95442763262823n),
          amount: new Amount(100n)
  ...
  it('TransferTransactionV1_transfer_single_7', () => {
  ...
  it('TransferTransactionV1_transfer_aggregate_1', () => {
  ...
  it('TransferTransactionV1_transfer_aggregate_2', () => {
  ...
  it('TransferTransactionV1_transfer_aggregate_3', () => {
  ...
  it('TransferTransactionV1_transfer_aggregate_4', () => {
  ...
  it('TransferTransactionV1_transfer_aggregate_5', () => {
  ...
  it('TransferTransactionV1_transfer_aggregate_6', () => {
  ...
  it('TransferTransactionV1_transfer_aggregate_7', () => {
  ...
  it('VotingKeyLinkTransactionV1_voting_key_link_single_1', () => {
  ...
  it('VotingKeyLinkTransactionV1_voting_key_link_single_2', () => {
  ...
  it('VotingKeyLinkTransactionV1_voting_key_link_aggregate_1', () => {
  ...
  it('VotingKeyLinkTransactionV1_voting_key_link_aggregate_2', () => {
  ...
  it('VrfKeyLinkTransactionV1_vrf_key_link_single_1', () => {
  ...
  it('VrfKeyLinkTransactionV1_vrf_key_link_single_2', () => {
  ...
  it('VrfKeyLinkTransactionV1_vrf_key_link_aggregate_1', () => {
  ...
  it('VrfKeyLinkTransactionV1_vrf_key_link_aggregate_2', () => {
